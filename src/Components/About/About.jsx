  ...
  return (
    <section className="py-10 bg-primary" id="sobre">
      <div className=" text-white ">
        <div className="xl:w-[105%] px-4 md:px-10 xl:px-24">
          <h1 className="text-3xl md:text-6xl lg:text-8xl font-chillaxSemibold uppercase">
        ...
        <div className="px-4 md:px-10 xl:px-24 pt-7 flex justify-between relative">
          <p className="font-poppins text-2xl md:text-3xl lg:w-4/6 xl:w-1/2">
        ...
        <div className="px-4 pt-10 md:px-10 xl:px-24 md:pt-16">
          <Link
            ...
            className="md:text-2xl lg:text-3xl font-poppins border-dotted border-b-4 border-secondary flex w-fit items-center pb-2 uppercase cursor-pointer cta-about"
            >
